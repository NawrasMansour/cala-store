...
const navigation = [
  ...
  { name: 'Colors', href: '/admin/colors', current: false },
]
                                                    ...
                                                    <>
                                                        <Popover.Button
                                                            className={classNames(
                                                                ...
                                                                'group rounded-md inline-flex items-center text-base font-medium px-3 py-2'
                                                            )}
                                                            id={navigation[1].name}
                ...
                <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold text-gray-900">
                        <InertiaLink
                            ...
                            href={route(props.routeBaseName == "admin.dashboard" ? props.routeBaseName : props.routeBaseName+".index")}
                        >
                            {props.title}
                        </InertiaLink>
                        {props.sub_title}
