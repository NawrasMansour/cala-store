...
const Show = (props) => {
  ...
  const onDelete = (e) => {
        e.preventDefault();
        inertiaDelete(route(`${props.routeBaseName}.destroy`, props.cluster.id), {
            //@ts-ignore
            onBefore: () =>
    ...
    <div className=" w-full space-x-2 p-5 rounded border border-gray-200 bg-white">
      <div className="lg:flex lg:items-center lg:justify-between">
        <div className="flex-1 min-w-0">
          <h2 className="capitalize text-5xl font-bold leading-7 text-gray-900 sm:text-5xl sm:truncate">{props.cluster?.en_name}</h2>
        ...
        <div className="mt-5 flex lg:mt-0 lg:ml-4">
          <span className="hidden sm:block">
            <button
              ...
              onClick={() => {
                        Inertia.get(route(`${props.routeBaseName}.edit`, props.cluster.id));
                    }}
            >
            ...
            <div className="mt-6">
              ...
              <div className="items-center">
                <div className='p-2 mb-2 flex flex-'>
                  ...
                  <span className="text-2xl font-semibold text-gray-900 sm:text-xl"> {props.cluster.sub_clusters.length} Sub Clusters</span>
                </div>
              </div>
            </div>
          ...
          <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{props.cluster?.en_description}</p>
              </div>
            </div>
          </div>
      </div>
