...
const Edit = (props) => {
  ...
  const { data, setData, post, processing, errors } = useForm({
        en_name: props.category.en_name || '',
        ar_name: props.category.ar_name || '',
        en_description:props.category.en_description || '',
        ar_description:props.category.ar_description || '',
        picture: '' as any,
        _method: 'PUT',
    });
  ...
  const submit = (e)=>{
    ...
    post(route(`${props.routeBaseName}.update`, props.category.id), {
            preserveState: (page) =>
